...
def get_params():
    ...
    args.add_argument("-seed", "--seed", default=1993, type=int)
    args.add_argument("-few", "--few", default=1, type=int)
    args.add_argument("-nq", "--num_query", default=5, type=int)
    args.add_argument("-td", "--text_dim", default=768, type=int)
    ...
    args.add_argument("-m", "--margin", default=2.0, type=float)  # default: 1
